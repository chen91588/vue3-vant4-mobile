...
<template>
  <van-form v-if="getShow" ref="formRef" class="flex flex-col items-center" @submit="handleSubmit">
    <van-field
      ...
      class="enter-y-3 items-center mb-25px !rounded-md"
      name="username"
      placeholder="用户名"
    ...
    <van-field
      ...
      class="enter-y-4 items-center mb-25px !rounded-md"
    ...
    <div class="enter-y-5 w-full px-5px flex justify-between mb-100px">
    ...
    <van-button
      class="enter-y-6 !rounded-md !mb-25px"
      type="primary"
      block
      native-type="submit"
      :loading="loading"
    ...
    <van-button
      class="enter-y-7 !mb-25 !rounded-md"
      plain
      type="primary"
      block
